...
% IK_tool_position.m. The script plots the robot's configurations as it
...
for r = 1:(size(wp,2)-1)
    ...
    [t_vec_curr, t_vec_mat] = IK_tool_position(panda, t_vec, wp{r+1}, true);
...
%%% Analyze and plot translation error and rotation change
